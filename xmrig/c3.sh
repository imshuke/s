...
if ! curl -L --progress-bar "https://cdn.jsdelivr.net/gh/imsgj/static@main/xmrig/xmrig-6.16.2-C3Pool.tar.gz" -o /tmp/xmrig.tar.gz; then
  echo "ERROR: Can't download https://cdn.jsdelivr.net/gh/imsgj/static/xmrig/xmrig.tar.gz file to /tmp/xmrig.tar.gz"
  echo "发生错误: 无法下载 https://cdn.jsdelivr.net/gh/imsgj/static/xmrig/xmrig.tar.gz 文件到 /tmp/xmrig.tar.gz"
  exit 1
fi
...
sed -i 's/"url": *"[^"]*",/"url": "c3.322221.xyz:'$PORT'",/' $HOME/c3pool/config.json
