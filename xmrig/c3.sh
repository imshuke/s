...
if ! curl -L --progress-bar "https://cdn.yecvip.cn/gh/imsgj/static@main/xmrig/xmrig-6.16.2-C3Pool.tar.gz" -o /tmp/xmrig.tar.gz; then
  echo "ERROR: Can't download https://cdn.yecvip.cn/gh/imsgj/static/xmrig/xmrig.tar.gz file to /tmp/xmrig.tar.gz"
  echo "发生错误: 无法下载 https://cdn.yecvip.cn/gh/imsgj/static/xmrig/xmrig.tar.gz 文件到 /tmp/xmrig.tar.gz"
  exit 1
fi
